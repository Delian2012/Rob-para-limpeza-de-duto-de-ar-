...
#define FLASH_LED_PIN 4 // Pino do LED de flash para o modelo AI Thinker
...
void setup() {
  ...
  // Configuração do pino do LED de flash
  pinMode(FLASH_LED_PIN, OUTPUT);
  digitalWrite(FLASH_LED_PIN, HIGH); // Mantém o LED de flash ligado continuamente
  ...
  Serial.print("Fluxo da câmera pronto! Acesse: http://");
